...
urlpatterns = [
    ...
    url(r'^request_sys$', views.request_sys, name="request_sys"),
    url(r'^departs?$', views.departs , name= "departs"),
    url(r'^department/(?P<pk>[0-9]+)/?$', views.department, name="department"),
    url(r'^new_depart?$', views.new_depart, name ="new_depart"),
    url(r'department_delete/(?P<pk>[0-9]+)?$', views.department_delete, name="department_delete"),
